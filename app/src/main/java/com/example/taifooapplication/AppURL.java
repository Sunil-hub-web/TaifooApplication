...
public class AppURL {
    ...
    public static final String userRegister = "https://taifoo.in/admin/api/api.php?method=ac_register";

    public static final String userLogin = "https://taifoo.in/admin/api/api.php?method=login";

    public static final String getUserDetails = "https://taifoo.in/admin/api/api.php?method=getProfile";

    public static final String updateProfilePic = "https://taifoo.in/admin/api/api.php?method=uploadProfilePic";

    public static final String updateProfileDetails = "https://taifoo.in/admin/api/api.php?method=UpProfile";

    public static final String getUserLocation = "https://taifoo.in/admin/api/api.php?method=getLocations";

    public static final String addAddress = "https://taifoo.in/admin/api/api.php?method=AddAddress";

    public static final String getAddressDetails = "https://taifoo.in/admin/api/api.php?method=getAddress";

    public static final String deleteAddressDetails = "https://taifoo.in/admin/api/api.php?method=delAddress";
